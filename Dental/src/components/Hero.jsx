...
const Hero = () => {
  return (
    <section id="home" className="scroll-m-20 bg-sky-100 py-16">
      <div className="container mx-auto px-20 flex flex-col-reverse lg:flex-row items-center justify-between gap-10">
        <div className="max-w-xl text-center lg:text-left space-y-6">
          ...
          <a
            href="#"
            className="inline-flex items-center bg-sky-600 text-white px-3 py-1 sm:px-6 sm:py-3 rounded-lg
        ...
        <div className="flex justify-center">
          <img
            src={hero_img}
            alt="Dental"
            className="w-80 lg:w-[430px] rounded-4xl"
          />
        </div>
      </div>
    </section>
